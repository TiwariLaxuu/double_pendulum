...
log_dir = "./log_data_sim2real/SAC_training_acrobot1"
...
training_steps = 3e4   # default = 1e6
verbose = 1
...
# Bounded directly between -0.15 and +0.15
# act_space = gym.spaces.Box(
#     low=np.array([-0.15], dtype=np.float32), 
#     high=np.array([0.15], dtype=np.float32)
# )
act_space = gym.spaces.Box(np.array([-1]), np.array([1]))
termination = False
